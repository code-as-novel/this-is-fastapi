...
async def create_book(book_request: BookRequest):
    new_book = Book(**book_request.model_dump())  # ** unpacks the dictionary
...
async def update_book(book: BookRequest, status_code=status.HTTP_204_NO_CONTENT):
    book_changed = False
...
# 204 는 생성한 것도 없고, 조회되는게 없다는 것을 의미한다.
